            ...
            <ScrollView>
                <View className='bg-white h-screen'>
                    ...
                    <View>
                        ...
                        <View className='flex flex-row gap-4 h-fit pr-20'>
                            <View className='p-2  h-fit'>
                                <Image source={require("../../assets/images/watch.png")} alt='images' className='h-[100px] w-[80px]' />
                                <Picker
                    ...
                    <View style={styles.buttonView}>
                        ...
                        <Text className='text-end font-semibold text-xl mt-4 '>19,000</Text>
           
                    <Pressable style={styles.bottomButton} className='bg-yellow-400 rounded-xl max-w-72  '
                        onPress={() => router.replace({
                            pathname: "/(zproduct)/payment",
